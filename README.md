...
[![CI](https://github.com/PlatformStackPulse/tf-atom-apigateway-domain-name-aws/actions/workflows/ci.yml/badge.svg)](https://github.com/PlatformStackPulse/tf-atom-apigateway-domain-name-aws/actions/workflows/ci.yml)
![Terraform](https://img.shields.io/badge/terraform-%3E%3D1.6.0-blueviolet)

## Purpose

Terraform atom: AWS API Gateway Domain Name - creates a custom domain.
...
| <a name="input_regional_certificate_arn"></a> [regional\_certificate\_arn](#input\_regional\_certificate\_arn) | ARN of the ACM certificate | `string` | n/a | yes |
...
| <a name="input_security_policy"></a> [security\_policy](#input\_security\_policy) | TLS version (TLS\_1\_0 or TLS\_1\_2) | `string` | `"TLS_1_2"` | no |
...
| <a name="output_id"></a> [id](#output\_id) | ID of the domain name |
| <a name="output_regional_domain_name"></a> [regional\_domain\_name](#output\_regional\_domain\_name) | Regional domain name for DNS alias |
| <a name="output_regional_zone_id"></a> [regional\_zone\_id](#output\_regional\_zone\_id) | Regional hosted zone ID for DNS alias |
<!-- END_TF_DOCS -->
